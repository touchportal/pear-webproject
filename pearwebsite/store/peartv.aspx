<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="peartv.aspx.cs" Inherits="store_peartv" %>
            ...
            <div class="product-content-left">
                <div class="product-image">
                    <asp:Image
                        ...
                        Height="130px"
                        Width="180px"
                        AlternateText="PearTV"
                        ImageAlign="middle"
                        ImageUrl="/content/peartv.png"
                        />
                </div>
            </div>
    ...
    <div class="body-description unselectable">
        <div class="description">
            <div class="description-content">
                <h5>PearTV is an HDMI-compliant source device. To use it for viewing, it has to be connected to an enhanced-definition or high-definition widescreen television via an HDMI cable. The device has no integrated controls and can only be controlled externally, either by an Pear Remote or Siri Remote control device using its infrared/Bluetooth capability, by the PearTV Remote app on pOS devices, such as the PearPhone, PearPod, PearPad, and PearWatch, using its Wi-Fi capability, or by some third-party gaming controllers and infrared remotes.</h5>
            </div>
        </div>
    </div>
</asp:Content>